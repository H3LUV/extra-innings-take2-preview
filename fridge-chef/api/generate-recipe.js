...
1. 서로 다른 레시피를 정확히 3개 만드세요.
   - title은 선택 재료명을 단순히 나열한 이름으로 만들지 마세요. '양파 계란 볶음밥', '연어 대파 크림구이'처럼 재료 목록이 그대로 제목이 되는 방식은 금지합니다.
   - title은 요리의 분위기와 조리법이 함께 떠오르는 창의적인 한국어 이름으로 12~28자 작성하세요. '바다의 낭만 크림 파스타', '불맛 벨벳 덮밥', '포근한 숲속 된장스튜'처럼 감성어와 요리 유형을 자연스럽게 조합하세요.
